...
const services = [
  {
    ...
    description:
      "AI-generated product demos, brand stories, and social ads delivered in 48 hours.",
    icon: Video,
  ...
  },
  {
    title: "Logo & Identity",
    description:
      "Distinctive visual identities that resonate with your audience and stand the test of time.",
    icon: Palette,
  ...
  },
  {
    ...
    description:
      "Fast, SEO-optimized, conversion-focused sites that turn visitors into customers.",
    icon: Globe,
  ...
  },
  {
    title: "Landing Pages",
    description:
      "High-converting landing pages designed to maximize your marketing ROI.",
    icon: MousePointer2,
  ...
  },
  {
    title: "SEO & Content",
    description:
      "Data-driven strategies to dominate search results and drive organic traffic.",
    icon: Megaphone,
  ...
  },
  {
    ...
    description:
      "Strategic ad campaigns on Google, Meta, and LinkedIn that scale your revenue.",
    icon: BarChart,
  ...
  },
  {
    ...
    description:
      "We create modern, fast, and user-friendly mobile apps for Android and iOS that help businesses grow digitally.",
    icon: Smartphone,
    accent: "from-purple-500 to-pink-500",
    badge: "50+ Apps Delivered",
  },
];
    ...
    <section className="py-24 bg-navy-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-brand-purple font-semibold tracking-wider uppercase text-sm">
            What We Do
          </span>
          ...
          <p className="text-slate-400 text-lg">
            Everything your brand needs to thrive online, powered by AI and
            human creativity.
          </p>
        </div>
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${
                  service.accent === "from-brand-blue to-brand-cyan"
