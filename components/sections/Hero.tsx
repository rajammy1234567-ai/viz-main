...
import { Calendar, ArrowRight, Globe, Target, Check, Star, Code, Smartphone, TrendingUp } from "lucide-react";
        ...
        <section className="relative min-h-[100vh] w-full bg-navy-900 overflow-hidden flex items-center pt-20 pb-12">
            ...
            <div className="container relative z-10 mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8 max-w-2xl font-lastica">
                    ...
                    >
                        <Badge variant="outline" className="px-4 py-2 text-brand-cyan border-brand-cyan/40 bg-brand-cyan/10 text-xs font-bold tracking-wider uppercase mb-7 backdrop-blur-sm">
                        ...
                        <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-lg mb-9">
                            From custom web and development to full-scale social management. We handle to the technical heavy lifting so you can focus on your business.
                        </p>
                    </motion.div>
                    ...
                    >
                        <Button size="lg" className="rounded-full px-8 py-6 text-base font-semibold bg-gradient-to-r from-brand-cyan to-brand-purple hover:from-brand-purple hover:to-brand-cyan shadow-[0_0_30px_rgba(0,242,255,0.5)] transition-all hover:scale-105 border-0">
                            Schedule Free Strategy Call
                            <Calendar className="ml-2 w-5 h-5" />
                        </Button>
                        <Button variant="outline" size="lg" className="rounded-full px-8 py-6 text-base font-semibold border-white/20 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm">
                            View Our Work
                        </Button>
                    </motion.div>
                ...
                <div className="relative h-[600px] hidden lg:block perspective-container top-[-58px]">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-sm mb-4">Start to End Solutions</p>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">App Development</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">Digital Management</h3>
